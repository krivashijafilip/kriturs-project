...
public class AddFragment extends Fragment {
    ...
    CollectionReference usersCollection = db.collection("transactions");
    ...
    private void findViews(View view) {
        ...
        submit_data = view.findViewById(R.id.add_submit_button);

        spinner = view.findViewById(R.id.add_category_spinner);
